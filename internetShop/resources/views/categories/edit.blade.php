                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="formGroupExampleInput" name="name" value="{{old('name',isset($category->name) ? $category->name : null)}}">
                                    @error('name')
                            ...
                            <li class="list-group-item">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="formGroupExampleInput" name="slug_name" value="{{old('slug_name',isset($category->name) ? $category->name : null)}}">
                                    @error('slug_name')
                                    <div class="alert alert-danger">{{$message}}</div>
                                    @enderror
                                </div>
                            ...
                            <li class="list-group-item">
                                <div class="form-group">
                                    ...
                                    <img src="{{ asset('/storage/'. $category->image) }}" width="100px" alt="">
                                </div>
                            </li>
